...
BEGIN
  ...
  IF _resource = 'property' THEN
    ...
    _limit := CASE _tier WHEN 'pro' THEN 9999 WHEN 'verwalten_plus' THEN 10 ELSE 1 END;
    IF _count >= _limit THEN
      RAISE EXCEPTION 'Maximal % Immobilie(n) im aktuellen Plan. Upgrade auf Pro für unbegrenzt Objekte.', _limit USING ERRCODE = 'check_violation';
    END IF;
